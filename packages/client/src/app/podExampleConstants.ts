...
export const EXAMPLE_EDDSA_PRIVATE_KEY = 'AAECAwQFBgcICQABAgMEBQYHCAkAAQIDBAUGBwgJAAE='; // hex 0001020304050607080900010203040506070809000102030405060708090001
export const EXAMPLE_EDDSA_PRIVATE_KEY2 = 'AAECAwQFBgcICQABAgMEBQYHCAkAAQIDBAUGBwgJAAA='; // hex 0001020304050607080900010203040506070809000102030405060708090000
...
export const EXAMPLE_POD_CONTENT = JSON.stringify(
  podEntriesToJSON({
    ...
    owner: {
      type: 'cryptographic',
      value: 18711405342588116796533073928767088921854096266145046362753928030796553161041n,
    },
    ownerV4: {
      type: 'eddsa_pubkey',
